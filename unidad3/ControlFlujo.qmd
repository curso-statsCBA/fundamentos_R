...
Cuando vimos los condicionales, armamos un código para [evaluar en 3 escenarios diferentes](#ejercicio-2) los gastos que realizaron Andrea y Ariel. Ahora que sabe usar bucles, escriba un código que evalué en una sola ejecución todos los escenarios planteados en ese ejercicio y que utilice todos los constructos aprendidos, es decir: `if`, `while` y `for`.
