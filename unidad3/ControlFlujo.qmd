...
Tomando de base el conjunto de datos `iris_more.csv`, la cual es idéntica al dataset iris pero contiene los datos de un total de 15 especies, construya el siguiente `data.frame` vacío:
