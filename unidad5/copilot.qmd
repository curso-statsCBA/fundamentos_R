...
La instalación de esta herramienta es muy simple. Como prerrequisito, debemos hacernos un usuario en [GitHub](https://github.com/){target="_blank"}. Luego, instalar o actualizar RStudio a una versión que soporte GitHub Copilot. Seguidamente, nos dirigimos a *Tools* \> *Global Options* \> *Copilot*. Allí, deberemos seguir las intrucciones, iniciar sesión con nuestro usuario y contraseña, y seguidamente activar la herramienta.
...
Ante preguntas o consultas más complicadas, recomendamos el uso de foros online como [Stack Overflow](https://stackoverflow.com/){target="_blank"}, así también como chatbots the preferencia, como [ChatGPT](https://chat.openai.com/){target="_blank"}, o incluso el mismo [GitHub Copilot](https://github.com/copilot){target="_blank"}, que también posee una versión de chat en el navegador.
