...
Dado que esto último es un uso relativamente avanzado, no haremos un ejercicio relacionado. No obstante, si tiene curiosidad sobre como se vería un script como el usado en el ejemplo de arriba, puede [descargarlo de aquí](https://raw.githubusercontent.com/pastornicolas/fundamentos_R/refs/heads/main/unidad1/no_interactivo.R) e intentar correrlo en su sistema operativo.
