...
O posteriormente con la función `levels`:

```{r}
levels(especies) <- c("Espinillo", "Quebracho", "Algarrobo")
especies
```
...
<p align="center"><a href="pics/meme_practico_vectores.png" target="_blank"><img src="pics/meme_practico_vectores.png" style="padding: 5px 0 5px 0;width: 50rem;max-width:100%;height:auto;vertical-align:middle;border-style: none;"/></a></p>
